...
const Footer = () => {
    return (
        <footer style={{ background: `url(${footer})`, backgroundSize: 'cover', backgroundPosition: 'center'}} className="p-10">
            ...
            <div>
                <footer className="footer footer-center p-4 text-base-content my-4 ">
                    <div>
